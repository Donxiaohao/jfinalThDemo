!
        ...
        CanvasRenderingContext2D.prototype.JTopoRoundRect = function(a, b, c, d, e) {
            ...
            JTopo = {
                ...
                MouseCursor: {
                    ...
                    move: "move",
                    open_hand: "url(./dist/static/img/cur/openhand.cur) 8 8, default",
                    closed_hand: "url(./dist/static/img/cur/closedhand.cur) 8 8, default",
                    collection_point: "url(./dist/static/img/cur/collectionPoint.cur) 30 30, default",
                    collection_point_white: "url(./dist/static/img/cur/collectionPointWhite.cur) 30 30, default"
                },
    ...
    function(a) {
        function b(c) {
            ...
            null != c && (c.add(this), this.addTo(c)),
                ...
                this.add = function(a) {
                    if(this.childs.indexOf(a) !== -1) return;
                    this.childs.push(a),
                ...
                this.mousedownHandler = function(b) {
                    ...
                    (null == this.currentElement || this.currentElement instanceof a.Link ||(c.target&& c.target.myType == "map") ) && 1 == this.translate && (this.lastTranslateX = this.translateX, this.lastTranslateY = this.translateY);
                    else {
                        ...
                        this.mode == a.SceneMode.select ? this.selectElement(c) : this.mode == a.SceneMode.edit && (this.selectElement(c), (null == this.currentElement || this.currentElement instanceof a.Link ||(c.target&& c.target.myType == "map") ) && 1 == this.translate && (this.lastTranslateX = this.translateX, this.lastTranslateY = this.translateY))
                    }

                    var _this = this;
                    window.onmousemove = function(e){
                        e.dx = e.screenX-b.screenX;
                        e.dy = e.screenY-b.screenY;
                        var c = _this.toSceneEvent(e);
                        _this.mode == a.SceneMode.normal ? null == _this.currentElement || _this.currentElement instanceof a.Link ||(c.target&& c.target.myType == "map") ? 1 == _this.translate && (_this.stage.cursor = a.MouseCursor.closed_hand, _this.translateX = _this.lastTranslateX + c.dx, _this.translateY = _this.lastTranslateY + c.dy) : _this.dragElements(c) : _this.mode == a.SceneMode.drag ? 1 == _this.translate && (_this.stage.cursor = a.MouseCursor.closed_hand, _this.translateX = _this.lastTranslateX + c.dx, _this.translateY = _this.lastTranslateY + c.dy) : _this.mode == a.SceneMode.select ? null != _this.currentElement ? 1 == _this.currentElement.dragable && _this.dragElements(c) : 1 == _this.areaSelect && _this.areaSelectHandle(c) : _this.mode == a.SceneMode.edit && (null == _this.currentElement || _this.currentElement instanceof a.Link ||(c.target&& c.target.myType == "map")  ? 1 == _this.translate && (_this.stage.cursor = a.MouseCursor.closed_hand, _this.translateX = _this.lastTranslateX + c.dx, _this.translateY = _this.lastTranslateY + c.dy) : _this.dragElements(c));
                    }
    ...
    function(a) {
        ...
        function c() {
            this.initialize = function() {
                ...
                this.paintSelected = function(a) {
                    ...
                    // 0 != this.showSelected && (a.save(), a.beginPath(), a.strokeStyle = "rgba(168,202,255, 0.9)", a.fillStyle = "rgba(168,202,236,0.7)", a.rect( - this.width / 2-2, -this.height / 2-2, this.width+4, this.height+4), a.fill(), a.closePath(), a.restore())
                    // 0 != this.showSelected && (
                    //     a.shadowBlur = 10,
                    //     a.shadowColor = "rgba(255,0,0,1)",
                    //     a.shadowOffsetX = 0,
                    //     a.shadowOffsetY = 0)
                },
        ...
        function d() {
            ...
            var b = ["Top_Left", "Top_Center", "Top_Right", "Middle_Right", "Bottom_Right", "Bottom_Center", "Bottom_Left","Middle_Left"];
            var getLinePosition = function(a,d,d1,e){
                var p = {};
                return "Top_Left" == a ? (p = {
                    from: {
                        x:d.left+e,
                ...
                if (0 != this.editAble) {
                    ...
                    for (var c = 0; c < b.length; c++) {
                        ...
                        a.strokeStyle = "rgba(0,0,0,1)",
                            ...
                            a.fill(),
                            a.closePath();
                        var d1= this.getCtrlPosition(b[c+1 < b.length?c+1:0]);
                        d1.left -= this.cx, d1.top -= this.cy;
                        var line = getLinePosition(b[c],d,d1,e);
                        if (line.from) {
                            a.beginPath();
                            a.setLineDash([2, 1]);
                            a.moveTo(line.from.x, line.from.y);
                            a.lineTo(line.to.x, line.to.y);
                            a.stroke();
                        }
                    }
                    a.restore()
    ...
    function(a) {
        ...
        function f(b, c, g) {
            ...
            this.initialize = function(b, c, d) {
                ...
                this.getPointExtend =  function(w,stx,sty,edx,edy,angle) {
                    var  p = {};
                    var r =Math.sqrt(w*w/2);
                    var k = (edy - sty) / (edx - stx);
                    if (!isFinite(k)){
                        p.y = edy>sty?sty+r:sty-r;
                        p.x = stx;
                    }
                    else{
                        var b = edy - k*edx;
                        var x1,y1,x2,y2;
                        var c = stx*stx + (b - sty)*(b- sty) -r*r;
                        var a = (1 + k*k);
                        var b1 = (2*stx - 2*k*(b - sty));
                    ...
                    //偏离中心
                    // if(angle){
                    //     var angleA = 180*Math.atan2((p.y-sty),(p.x-stx))/Math.PI;
                    //     var angleB = Math.abs(angleA-angle)>180?(angleA-angle)>0?(angleA-angle-360):(360+(angleA-angle)):angleA-angle
                    //     var xa = Math.cos(angleB*Math.PI/180)*r;
                    //     var ya = Math.sin(angleB*Math.PI/180)*r;
                    //     p.x = xa+stx;
                    //     p.y = ya+sty;
                    // }
                    return p;
                ...
                this.getStartPosition = function() {
                    ...
                    //     y:this.nodeA.cy,
                    // }
                    var a = this.getPointExtend(this.nodeA.width,this.nodeA.cx,this.nodeA.cy,this.nodeZ.cx,this.nodeZ.cy);
                    return a
                },
                this.getEndPosition = function() {
                    var a;
                    return null != this.arrowsRadius && (a = h(this.nodeZ, this.nodeA)),
                    null == a && (a = this.getPointExtend(this.nodeA.width,this.nodeZ.cx,this.nodeZ.cy,this.nodeA.cx,this.nodeA.cy)
                        // {
                        //     x:this.nodeZ.cx,
                        //     y:this.nodeZ.cy,
                        // }
            ...
            this.initialize = function() {
                ...
                this.getPath = function() {
                    ...
                    var f, g, h = e(this.nodeA, this.nodeZ),
                        ...
                        j = this.bundleGap * this.nodeIndex - i / 2;
        ...
        function h(a, b, c) {
            this.initialize = function() {
                ...
                this.initialize(a, b, c),
                this.getStartPosition = function(direction) {
                    var a = {
                        x: this.nodeA.cx,
                        y: this.nodeA.cy
                    };
                    return (!direction && (direction = this.direction)),"horizontal" == direction ? a.x = this.nodeZ.cx <= a.x ? this.nodeA.x: this.nodeA.x + this.nodeA.width: a.y = this.nodeZ.cy <= a.y ? this.nodeA.y: this.nodeA.y + this.nodeA.height,
                        a
                },
                this.getEndPosition = function(direction) {
                    var a = {
                        x: this.nodeZ.cx,
                        y: this.nodeZ.cy
                    };
                    return (!direction && (direction = this.direction)),"horizontal" == direction ? a.x = this.nodeA.cx < a.x ? this.nodeZ.x: this.nodeZ.x + this.nodeZ.width: a.y = this.nodeA.cy < a.y ? this.nodeZ.y: this.nodeZ.y + this.nodeZ.height,
                        a
                },
                this.getPath = function() {
                    ...
                    "horizontal" === this.direction? ((this.nodeA.cx <= this.nodeZ.cx && b.x >= c.x) || (this.nodeA.cx >= this.nodeZ.cx && b.x <= c.x)) && (direction = 'vertical',b = this.getStartPosition(direction),c = this.getEndPosition(direction)):
                        ((this.nodeA.cy <= this.nodeZ.cy && b.y >= c.y) || (this.nodeA.cy >= this.nodeZ.cy && b.y <= c.y)) && (direction = 'horizontal',b = this.getStartPosition(direction),c = this.getEndPosition(direction));
                    if (this.nodeA === this.nodeZ) return [b, c];
                    var d = [],
                        f = e(this.nodeA, this.nodeZ),
                        g = (f - 1) * this.bundleGap,
                        h = this.bundleGap * this.nodeIndex - g / 2,
                        // i = this.offsetGap;
                        //修改
                        i = "horizontal" == direction ?Math.abs(b.x-c.x)/2:Math.abs(b.y-c.y)/2;
                    return "horizontal" == direction ? (this.nodeA.cx > this.nodeZ.cx && (i = -i), d.push({
                        x: b.x,
                        y: b.y + h
                    }), d.push({
                        x: b.x + i,
