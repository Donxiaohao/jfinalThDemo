...
import com.xxx.oam.util.ToolDirFileUtil;
...
public class I18NPlugin implements IPlugin {
    ...
    public static final String i18n_local_ru_RU = "ru_Ru";
	...
	public static String columnSuffix(String i18n){
		...
		} else if(i18n.equals(i18n_local_ru_RU)){
			val = "_ruru";
	...
	public static String localParse(String localePram){
		...
		}else if(localePram.equals("ru") || localePram.equals("ru_ru")){
			localePram = i18n_local_ru_RU;
	...
	public boolean start() {
		...
		String fileNamePrefix = "message";
		String fileName = null;
		String classesPath = ToolDirFileUtil.getClassesPath();
